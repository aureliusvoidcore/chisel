...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h13f4f6b17227913b: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h0d9e006ddf9c07f8: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures_____invoke__h1faaef7ba66d88d0: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures_____invoke__ha5458f8db50a2a53: (a: number, b: number) => [number, number];
  readonly wasm_bindgen__convert__closures_____invoke__h669d3b24e181f8c9: (a: number, b: number, c: any, d: any) => void;
